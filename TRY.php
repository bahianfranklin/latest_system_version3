                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="container mt-5">
                        <div class="card p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h3 class="mb-0">Welcome, <?= htmlspecialchars($user['name'] ?? 'User'); ?> 👋</h3>
                    ...
                    <div class="container">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        if ($todaySchedule === "work_from_home") {
                            ...
                            <!-- Onsite Attendance for current month -->
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card mb-3">
                                    <div class="card-header bg-secondary text-white">Onsite Attendance</div>
                                    <div class="card-body" id="attendanceSection">Loading attendance data...</div>
                                </div>
                            </div>
                ...
                fetch("DASHBOARD_DATA.php")
                    ...
                    .then(data => { 
                        ...
                        if (data.pending) {
                            ...
                            setIf('pendingLeaves', data.pending.leaves);
                            setIf('pendingOvertime', data.pending.overtime);
                            setIf('pendingOB', data.pending.official_business);
                            setIf('pendingCS', data.pending.change_schedule);
                            setIf('pendingFC', data.pending.failure_clock);
                            setIf('pendingCA', data.pending.clock_alteration);
                            setIf('pendingWR', data.pending.work_restday);
                            const approverCard = document.querySelector('.card.bg-danger');
                            if (approverCard) approverCard.style.display = 'block';
                        } else {
                            const approverCard = document.querySelector('.card.bg-danger');
                            if (approverCard) approverCard.style.display = 'none';
                        }
                    });
            }
