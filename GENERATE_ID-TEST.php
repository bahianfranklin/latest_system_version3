...
========================= */
$settings = $pdo->query("
    SELECT company_name, address, telephone_number, system_logo
...
<div id="layoutSidenav_content">
    ...
    <script>
        ...
        function generateID() {
            ...
            const logoPath = SYSTEM_SETTINGS.system_logo
                ? `uploads/logos/${SYSTEM_SETTINGS.system_logo}`
                : '';

            const logoHTML = logoPath
                ? `<img src="${logoPath}" class="id-logo">`
                : '';
            ...
            preview.innerHTML = `
                    <div class="id-card front">
                        ${logoHTML}
                        <h6 class="id-title"><b>${escape(SYSTEM_SETTINGS.company_name || '')}</b></h6>
                        <p>${escape(SYSTEM_SETTINGS.address || '')}</p>
                        <p>Tel: ${escape(SYSTEM_SETTINGS.telephone_number || '')}</p>
                        ${photoHTML}
                    ...
                    <div class="id-card back">
                        ...
                        <hr>
                        <p class="title-strong"><strong>${escape(SYSTEM_SETTINGS.company_name || '')}</strong></p>
