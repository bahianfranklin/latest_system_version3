                ...
                <tbody>
                    <?php $i = $offset + 1;
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm editBtn" data-id="<?= $data['id'] ?>" data-fullname="<?= htmlspecialchars($data['fullname']) ?>" data-address="<?= htmlspecialchars($data['address']) ?>" data-contact="<?= htmlspecialchars($data['contact_no']) ?>" data-bs-toggle="modal" data-bs-target="#editModal">Edit</button>
