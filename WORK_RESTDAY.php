...
foreach ($daysMap as $dayName => $dayNum) {
    if (isset($sched[$dayName]) && $sched[$dayName] === 'rest_day') {
        $restDays[] = $dayNum;
    }
}
...
<div id="layoutSidenav_content">
    <main class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addModal">+ Apply Work Rest
                Day</button>
        </div>
                            ...
                            <form method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <label>Date</label>
                                        <input type="date" name="date" value="<?= $row['date'] ?>" class="form-control mb-2"
                                            required>
                                        <label>From Time</label>
                                        <input type="time" name="from_time" value="<?= $row['from_time'] ?>"
                                            class="form-control mb-2" required>
                                        <label>To Time</label>
                                        <input type="time" name="to_time" value="<?= $row['to_time'] ?>"
                                            class="form-control mb-2" required>
                                        <label>Purpose</label>
